...
function startRun() {
    runExercise([
        ...
        ['आज का दिन बहुत शानदार है। हम १३ मिनट तक दौड़ेंगे। यह हमारा पल है और आनंद लेने का क्षण है। हम ३० सेकंड में शुरू करेंगे। शुभकामनाएँ!', 0],
        ['वू हूऊऊ, चलिए दौड़ते हैं!', 0],
        ['अब ६ मिनट शेष हैं', 0],
        ['अगले ४ मिनट तक जारी रखें', 0],
        ['अब सिर्फ ३ मिनट शेष हैं!', 0],
        ['अब सिर्फ २ मिनट शेष हैं!', 0],
        ['अंतिम १ मिनट शेष है!', 0],
        ['शानदार! दौड़ अब पूरी हो गई है। आराम करें! कल इसी समय मिलेंगे!', 0]
    ]);
}
